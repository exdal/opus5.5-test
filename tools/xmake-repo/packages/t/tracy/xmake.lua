package("tracy")
    ...
    -- oxcity override: github.com/<repo>/commit/<sha>.patch is blocked in the sandbox, this is the same commit
    -- produced locally with `git format-patch -1 d79b6d04` (see tools/sandbox/bootstrap.sh)
    add_patches("v0.13.1", path.join(os.scriptdir(), "patches", "d79b6d04.patch"), "7eee91b56d0e3f24f82a7d67a09502bc98d87f37d52aca18c19d897f578a02cd")

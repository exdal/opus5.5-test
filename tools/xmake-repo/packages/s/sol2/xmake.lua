package("sol2")
    ...
    on_install(function (package)
        -- oxcity override: sol2 is header only. its cmake either FetchContent-downloads lua from lua.org
        -- (SOL2_BUILD_LUA, blocked in the sandbox) or insists on find_package(Lua) (not installed system wide),
        -- neither is needed to install headers, so skip cmake entirely
